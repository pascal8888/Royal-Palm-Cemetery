...
## Analayze data from Royal Palm Cemetary - 101 55th Street South, Saint Petersburg, Florida, 33707. Captured manually 2000 - 2001. See raw source file (RPC.txt) for a complete description of the data collection process including persons involved.
...
## Read the file into a data table starting at the first line with interrment data (51).
...
bornYears <- sort(bornYears[l]) ## This is the array for the years in which persons interred at Royal Palm Cemetary were born
...
diedYears <- sort(diedYears[m]) ## This is the array for the years in which persons interred at Royal Palm Cemetary died
